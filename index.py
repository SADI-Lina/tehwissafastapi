...
from routes import stat, most_visited, image_event, home, point_d_interet , adresse , theme , categorie , image , commentaire , tourist_user , evenement , type_event,moyen_transport
...
app.include_router(image_event.router)
